...
const SearchOffersScreen = ({ navigation, route }) => {
  ...
  }, [searchText, selectedPriceRange, selectedSortOption]);
            ...
            <View style={styles.recentlyVisitedSection}>
              <View style={styles.sectionHeader}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                  <TouchableOpacity onPress={handleClearRecentlyVisited} style={{ marginRight: 12 }}>
                    <Text style={{ color: '#e11d48', fontWeight: '500', fontSize: 14, padding: 12 }}>Clear</Text>
                  </TouchableOpacity>
